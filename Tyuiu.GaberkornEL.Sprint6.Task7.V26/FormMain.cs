...
using Tyuiu.GaberkornEL.Sprint6.Task7.V26.Lib;

namespace Tyuiu.GaberkornEL.Sprint6.Task7.V26
{
    public partial class FormMain : Form
    {
        ...
        private void buttonOpen_Click(object sender, EventArgs e)
        {
            ...
            ofd.Filter = "CSV фаил (*.csv)|*.csv|фаил (*.*)|*.*";
        ...
        private void buttonProcess_Click(object sender, EventArgs e)
        {
            ...
            sfd.Filter = "CSV фаил (*.csv)|*.csv| фаил (*.*)|*.*";
            sfd.FileName = "OutPutFileTask7.csv";

            if (sfd.ShowDialog() == DialogResult.OK)
            {
                ds.SaveMatrix(resultMatrix, sfd.FileName);
                MessageBox.Show("тт: " + sfd.FileName);
            }
        }

        private void buttonInfo_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Таск 7, Вариант 26", "Инфо");
        }
